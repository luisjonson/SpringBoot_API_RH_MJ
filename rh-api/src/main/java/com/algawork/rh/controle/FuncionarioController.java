package com.algawork.rh.controle;

import com.algawork.rh.model.Funcionario;
import com.algawork.rh.repository.FuncionarioRepository;
...
public class FuncionarioController {
    ...
    public ResponseEntity<Funcionario> atualizar(@PathVariable Long funcionarioId, @RequestBody Funcionario funcionario) {
        if (Boolean.FALSE.equals(funcionarioRepository.existsById(funcionarioId))) {
